...
print("Aguarde um momento, seu vídeo está sendo transcrito...")

# Rodando o comando para transcrever o arquivo mp3
command_transcribe = f'whisper --task transcribe --language Portuguese --model large "{file_name}"'
os.system(command_transcribe)

# Informando ao usuário que o vídeo foi transcrito com sucesso
print("Seu vídeo foi transcrito com sucesso.")
